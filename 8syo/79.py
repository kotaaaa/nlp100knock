...
plt.plot(thresholds, accuracys, color='green', linestyle='--', label='accuracy')
plt.plot(thresholds, precisions, color='red', linewidth=3, label='precision')
plt.plot(thresholds, recalls, color='blue', linewidth=3, label='recall')
plt.plot(thresholds, f1s, color='magenta', linestyle='--', label='F1-score')
